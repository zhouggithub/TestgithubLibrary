package com.example.zhouganglibrary.views.banner;
...
import cn.hktoutiao.toutiao.utils.SizeUtils;
...
//    private static final int RWC = RelativeLayout.LayoutParams.WRAP_CONTENT;
    ...
    private int mPointDrawableResId = R.drawable.zg_bga_banner_selector_point_solid;
    ...
    private void initDefaultAttrs(Context context) {
        RWC = SizeUtils.dp2px(context, 115);

        mAutoPlayTask = new AutoPlayTask(this);

        mPointLeftRightMargin = BGABannerUtil.dp2px(context, 3);
        mPointTopBottomMargin = BGABannerUtil.dp2px(context, 20);
        mPointContainerLeftRightPadding = BGABannerUtil.dp2px(context, 15);
...
//        RelativeLayout.LayoutParams indicatorLp = new RelativeLayout.LayoutParams(RWC, RWC);
        LayoutParams indicatorLp = new LayoutParams(LayoutParams.WRAP_CONTENT, RWC);
        ...
        if (mIsNumberIndicator) {
            ...
            mPointRealContainerLl.setGravity(Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL);
        ...
        mTipTv.setGravity(Gravity.LEFT|CENTER_HORIZONTAL|Gravity.CENTER_VERTICAL);
        mTipTv.setMaxLines(2);
...
//            tipLp.addRule(RelativeLayout.LEFT_OF, R.id.banner_indicatorId);
    ...
    public LinearLayout getPointRealContainerLl() {
        return mPointRealContainerLl;
    }

    public void setPointRealContainerLl(LinearLayout pointRealContainerLl) {
        mPointRealContainerLl = pointRealContainerLl;
    }
