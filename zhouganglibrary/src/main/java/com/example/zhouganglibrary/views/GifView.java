...
import cn.hktoutiao.toutiao.utils.ScreenUtils;
...
public class GifView extends View{
    ...
    public void setGifResource(String  moviePath) {
        this.mPath = moviePath;
//        this.mMovieResourceId = movieResourceId;
        mMovie = Movie.decodeFile(mPath);
//        mMovie = Movie.decodeStream(getResources().openRawResource(mMovieResourceId));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LogUtils.info("onLayout== l=="+l+"t== mTop"+t+"r=="+r+"b=="+b);
    ...
    private void drawMovieFrame(Canvas canvas) {
        ...
        LogUtils.info("xxxxx="+mLeft / mScale+"yyyyy="+mTop / mScale+"zzz="+ScreenUtils.getStatusHeight(mContext));
//        mMovie.draw(canvas, mLeft / mScale, mTop / mScale);

        mMovie.draw(canvas, mLeft / mScale, ScreenUtils.getStatusHeight(mContext)*3);
        canvas.restore();
    }
