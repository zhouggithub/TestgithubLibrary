...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    public static String REFRESH_FOOTER_PULLUP = "上拉加載更多";
    public static String REFRESH_FOOTER_RELEASE = "释放立即加載";
    public static String REFRESH_FOOTER_LOADING = "正在加載...";
    public static String REFRESH_FOOTER_REFRESHING = "正在刷新...";
    public static String REFRESH_FOOTER_FINISH = "加載完成";
    public static String REFRESH_FOOTER_FAILED = "加載失败";
    public static String REFRESH_FOOTER_ALLLOADED = "全部加載完成";
